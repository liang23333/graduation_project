...
def net(split):
	...
	n.conv1_1_down=conv1x1(n.conv1_1)
	n.conv1_2_down=conv1x1(n.conv1_2)
	n.fuse1=L.Eltwise(n.conv1_1_down,n.conv1_2_down,operation=P.Eltwise.SUM)
	n.dsn1=conv1x1(n.fuse1,weight=dict(type='guassian',std=0.01))
	...
	#conv2
	n.conv2_1_down=conv1x1(n.conv2_1)
	n.conv2_2_down=conv1x1(n.conv2_2)
	n.fuse2=L.Eltwise(n.conv2_1_down,n.conv2_2_down,operation=P.Eltwise.SUM)
	n.dsn2=conv1x1(n.fuse2,weight=dict(type='gaussian',std=0.01))
	...
	#conv3
	n.conv3_1_down=conv1x1(n.conv3_1)
	n.conv3_2_down=conv1x1(n.conv3_2)
	n.conv3_3_down=conv1x1(n.conv3_3)
	n.fuse3=L.Eltwise(n.conv3_1_down,n.conv3_2_down,n.conv3_3_down,operation=P.Eltwise.SUM)
	n.dsn3=conv1x1(n.fuse3,weight=dict(type='gaussian',std=0.01))
	...
	#conv4
	n.conv4_1_down=conv1x1(n.conv4_1)
	n.conv4_2_down=conv1x1(n.conv4_2)
	n.conv4_3_down=conv1x1(n.conv4_3)
	n.fuse4=L.Eltwise(n.conv4_1_down,n.conv4_2_down,n.conv4_3_down,operation=P.Eltwise.SUM)
	n.dsn4=conv1x1(n.fuse4,weight=dict(type='gaussian',std=0.01))
	...
	#conv5
	n.conv5_1_down=conv1x1(n.conv5_1)
	n.conv5_2_down=conv1x1(n.conv5_2)
	n.conv5_3_down=conv1x1(n.conv5_3)
	n.fuse5=L.Eltwise(n.conv5_1_down,n.conv5_2_down,n.conv5_3_down,operation=P.Eltwise.SUM)
	n.dsn5=conv1x1(n.fuse5,weight=dict(type='gaussian',std=0.01))
